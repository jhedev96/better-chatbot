...
## [1.5.2](https://github.com/jhedev96/better-chatbot/compare/v1.21.0...v1.5.2) (2025-08-25)
...
* add loading state to ToolSelector and refactor MCP server handling in McpServerSelector ([b9fb409](https://github.com/jhedev96/better-chatbot/commit/b9fb40944e24451d357edb426b6b9bb6ff0d8fd2))
...
* add remark-gfm for table / footnote support ([f044699](https://github.com/jhedev96/better-chatbot/commit/f044699bf355cb890b18cc8b6698566c96a684b7))
* add remark-gfm for table / footnote support ([449cffc](https://github.com/jhedev96/better-chatbot/commit/449cffc8dbbbf7510c91a5866eb2de869bdb13ca))
...
* enhance MCP server selection with link to add a server when none are detected ([e8a4e1c](https://github.com/jhedev96/better-chatbot/commit/e8a4e1c0d0aa24e3d3aaa6bc5f4eb796bff334d3))
...
* implement real-time chat session creation with OpenAI API ([24c3947](https://github.com/jhedev96/better-chatbot/commit/24c3947498ee1e630bd5ce62f1ca2c173cda16a9))
...
* adjust background color in dark mode for improved contrast in globals.css ([f3dddf9](https://github.com/jhedev96/better-chatbot/commit/f3dddf96fd28059e137bb9b1ba2de3db922afd9c))
...
* correct conditional rendering for MCP server list in McpServerSelector component ([3402ba3](https://github.com/jhedev96/better-chatbot/commit/3402ba33256da4029d3d9d46dfafc25cb3b57acb))
